...
public class Tilesheet {
	...
	public Tilesheet(String name) {
		...
		try {
			BufferedImage image = ImageIO.read(Main.class.getClassLoader().getResource("res/tilesheet/" + name.toLowerCase() + ".png")); // I don't use ImageUtil because I need a BufferedImage.
