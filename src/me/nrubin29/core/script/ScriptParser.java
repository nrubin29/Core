...
import me.nrubin29.core.script.cmds.AudioCommand;
import me.nrubin29.core.script.cmds.EventCommand;
import me.nrubin29.core.script.cmds.ItemCommand;
import me.nrubin29.core.script.cmds.MapCommand;
import me.nrubin29.core.script.cmds.PopupCommand;

/*
 * This class handles parsing CoreScript, Core's implementation of a game scripting language.
 * With CoreScript, you can tap into Core's power from your own map!
 * 
 * Sample inputs:
 * 
...
public class ScriptParser {
	...
	public void parse(String input) {
		try {
			...
			Class<? extends ScriptCommand> cmdClass = (Class<? extends ScriptCommand>) Class.forName("me.nrubin29.core.script.cmds." + cmdClassName + "Command");
