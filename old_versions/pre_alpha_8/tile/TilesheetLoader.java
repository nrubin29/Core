...
public class TilesheetLoader {
	...
	public static HashMap<Point, ImageIcon> tiles = new HashMap<Point, ImageIcon>();
	
	public static void loadTiles() {
		try {
			BufferedImage image = ImageIO.read(Main.class.getClassLoader().getResource("res/tilesheet/tilesheet.png")); // I don't use ImageUtil because I need a BufferedImage.
