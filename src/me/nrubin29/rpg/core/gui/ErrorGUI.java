...
public class ErrorGUI extends JFrame {
	...
	public ErrorGUI(final Throwable e) {
		super("Error");
		
		JLabel player = new JLabel(ImageUtil.resizeImage(ImageUtil.getImage("sprites/player/downStatic"), 25, 25));
